...
function probability(c) {
  const vals = [
    ...
    c.distributionProb,
    c.twoSidedPricing?.selectedProb,
    c.prob,
    c.finalProbability,
    ...
    c.evProbability,
    c.raw?.probability,
    c.raw?.recommendedProb,
    c.raw?.calibratedDistributionProb,
    c.raw?.contextAdjustedDistributionProb,
    c.raw?.preContextCalibratedDistributionProb,
    c.raw?.distributionProb,
    c.raw?.twoSidedPricing?.selectedProb,
    c.raw?.prob,
    ...
    c.leg?.twoSidedPricing?.selectedProb,
    c.leg?.prob,
    ...
    c.legs?.[0]?.twoSidedPricing?.selectedProb,
    c.legs?.[0]?.prob,
